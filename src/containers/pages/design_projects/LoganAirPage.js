    ...
    return ( 
        <div>
            ...
            <div>
                ...
                <div className='flex-container'>
                    <img className='two-row' src={require('assets/images/design_projects/logan_air/old_logo.png')} alt='logan air logo'/>
                    <img className='two-row' src={require('assets/images/design_projects/logan_air/logo_banner.png')} alt='logan air old logo'/>
                </div>
            </div>
            <div>
