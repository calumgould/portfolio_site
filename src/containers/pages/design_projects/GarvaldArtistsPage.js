        ...
        <div>
            ...
            <div>
                ...
                <div className='flex-container'>
                    ...
                    <img className='one-row' src={require('assets/images/design_projects/garvald_artists/mockups/mockup_booklet1.png')} alt='booklet inside'/>
                    <img className='one-row' src={require('assets/images/design_projects/garvald_artists/mockups/mockup_booklet2.png')} alt='booklet inside'/>
            </div>
            <div>
